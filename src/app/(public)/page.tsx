  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-mipc-navy-950 text-white">
        <Image src="/campus-front.jpg" alt="Front view of the MIPC campus in Musanze" fill priority sizes="100vw" className="object-cover" />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(6,16,34,.98)_0%,rgba(6,16,34,.91)_40%,rgba(29,73,50,.66)_70%,rgba(6,16,34,.14)_100%)]" />
        <div className="relative mx-auto grid min-h-[700px] max-w-7xl items-center gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:py-24">
          <div className="max-w-3xl">
            <div className="mb-7 flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.2em] text-mipc-green-300"><span className="h-px w-9 bg-mipc-green-400" />Musanze · Rwanda · Established 2014</div>
            <h1 className="font-display text-5xl font-bold leading-[.98] tracking-tight sm:text-6xl lg:text-7xl">Practical learning.<br /><span className="text-mipc-green-300">Purposeful futures.</span></h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/85">MIPC brings technology, hospitality and construction education into the real world — with practical training, close support and a campus community built around integrity, service and excellence.</p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Link href="/admissions/apply" className="mipc-button-primary !bg-mipc-green-700 hover:!bg-mipc-green-600">Start your application <ChevronRightIcon className="h-4 w-4" /></Link><Link href="#programmes" className="mipc-button-secondary !border-white/35 !bg-transparent !text-white hover:!bg-white/10">Explore programmes <ChevronRightIcon className="h-4 w-4" /></Link></div>
          </div>
      ...
      <section className="bg-[#f7f8f5]">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:py-24">
          ...
          <div className="relative min-h-[360px] overflow-hidden rounded-[1.75rem] shadow-academic-lg sm:min-h-[460px]"><Image src="/campus-side.jpg" alt="Side view of the MIPC campus and landscaped grounds" fill sizes="(min-width: 1024px) 55vw, 100vw" className="object-cover" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/35 via-transparent to-transparent" /></div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-24">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-12">
            <article className="group relative min-h-[480px] overflow-hidden rounded-[1.6rem] bg-mipc-navy-950 lg:col-span-7"><Image src="/graduation-procession.jpg" alt="MIPC graduates walking together on campus" fill sizes="(min-width: 1024px) 58vw, 100vw" className="object-cover transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/90 via-mipc-navy-950/10 to-transparent" /><div className="absolute inset-x-0 bottom-0 p-7 text-white sm:p-9"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Achievement</p><h3 className="mt-2 max-w-xl text-3xl font-bold">Celebrating the work behind every graduation day.</h3></div></article>
            <div className="grid gap-5 sm:grid-cols-2 lg:col-span-5 lg:grid-cols-1">
              <article className="group relative min-h-[300px] overflow-hidden rounded-[1.6rem] bg-mipc-green-900"><Image src="/construction-graduates.jpg" alt="Construction and Building Technology graduates at MIPC" fill sizes="(min-width: 1024px) 42vw, 100vw" className="object-cover transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/88 via-transparent to-transparent" /><div className="absolute inset-x-0 bottom-0 p-6 text-white"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Programme pride</p><h3 className="mt-2 text-xl font-bold">Skills that become real careers.</h3></div></article>
              <article className="group relative min-h-[300px] overflow-hidden rounded-[1.6rem] bg-mipc-navy-950"><Image src="/leadership-community.jpg" alt="MIPC youth leadership and community group" fill sizes="(min-width: 1024px) 42vw, 100vw" className="object-cover transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/88 via-transparent to-transparent" /><div className="absolute inset-x-0 bottom-0 p-6 text-white"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Leadership & community</p><h3 className="mt-2 text-xl font-bold">Growing confidence beyond the lecture room.</h3></div></article>
            </div>
          </div>
        </div>
      </section>
