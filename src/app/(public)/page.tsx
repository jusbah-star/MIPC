  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-mipc-navy-950 text-white">
        <img src={photos.hero} alt="MIPC campus community in Musanze" className="absolute inset-0 h-full w-full object-cover object-center" fetchPriority="high" />
      ...
      <section className="bg-[#f7f8f5]">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:py-24">
          ...
          <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-mipc-navy-950 shadow-academic-lg sm:aspect-[16/10]"><img src={photos.campus} alt="Side view of the MIPC campus and landscaped grounds" loading="lazy" className="absolute inset-0 h-full w-full object-cover object-center" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/20 via-transparent to-transparent" /></div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-24">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-12">
            <article className="group relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-mipc-navy-950 sm:aspect-[16/10] lg:col-span-7 lg:aspect-auto lg:min-h-[500px]"><img src={photos.graduation} alt="MIPC graduates and faculty celebrating on campus" loading="lazy" className="absolute inset-0 h-full w-full object-cover object-center transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/90 via-mipc-navy-950/10 to-transparent" /><div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-8"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Achievement</p><h3 className="mt-2 max-w-xl text-2xl font-bold sm:text-3xl">Celebrating the work behind every graduation day.</h3></div></article>
            <div className="grid gap-5 sm:grid-cols-2 lg:col-span-5 lg:grid-cols-1">
              <article className="group relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-mipc-green-900 sm:aspect-[16/10] lg:aspect-auto lg:min-h-[240px]"><img src={photos.construction} alt="Construction and Building Technology graduates at MIPC" loading="lazy" className="absolute inset-0 h-full w-full object-cover object-center transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/90 via-transparent to-transparent" /><div className="absolute inset-x-0 bottom-0 p-6 text-white"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Programme pride</p><h3 className="mt-2 text-xl font-bold">Skills that become real careers.</h3></div></article>
              <article className="group relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-mipc-navy-950 sm:aspect-[16/10] lg:aspect-auto lg:min-h-[240px]"><img src={photos.community} alt="MIPC graduates and community members" loading="lazy" className="absolute inset-0 h-full w-full object-cover object-center transition duration-500 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-mipc-navy-950/90 via-transparent to-transparent" /><div className="absolute inset-x-0 bottom-0 p-6 text-white"><p className="text-xs font-bold uppercase tracking-[0.18em] text-mipc-green-300">Leadership & community</p><h3 className="mt-2 text-xl font-bold">Growing confidence beyond the lecture room.</h3></div></article>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-mipc-navy-950 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[.8fr_1.2fr] lg:py-24">
